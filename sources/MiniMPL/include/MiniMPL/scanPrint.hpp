...
namespace MiniMPL
{
        ...
        */
        ...
        template<>                struct GetFmtArr<char>        : ValueType<const char *const *,strFmtA>                               {};
        template<>                struct GetFmtArr<wchar_t>     : ValueType<const wchar_t *const *,strFmtW>                            {};
        ...
        template<>                struct GetScanfFunc<char>     : ValueType<typename StrScanfType<char>::type, sscanf>                 {}; 
        template<>                struct GetScanfFunc<wchar_t>  : ValueType<typename StrScanfType<wchar_t>::type, swscanf>             {}; 
        ...
        template<>                struct GetScanfFuncS<char>     : ValueType<typename StrScanfTypeS<char>::type, sscanf_s>              {}; 
        template<>                struct GetScanfFuncS<wchar_t>  : ValueType<typename StrScanfTypeS<wchar_t>::type, swscanf_s>          {}; 
        ...
        template<>                struct GetPrintfFunc<char>    : ValueType<typename StrPrintType<char>::type, sprintf>                {}; 
        template<>                struct GetPrintfFunc<wchar_t> : ValueType<typename StrPrintType<wchar_t>::type, swprintf>            {}; 
#endif // ENABLE_UNSAFE_SCANPRINT
        ...
        template<>                struct GetPrintfFuncS<char>   : ValueType<typename StrPrintTypeS<char>::type, sprintf_s>             {}; 
        template<>                struct GetPrintfFuncS<wchar_t>: ValueType<typename StrPrintTypeS<wchar_t>::type, swprintf_s>         {}; 
}
